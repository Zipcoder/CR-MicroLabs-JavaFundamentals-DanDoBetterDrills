...
public class StringUtilities {
    ...
    public static String getSuffix(String input)
    {
        ...
        return input.substring(strLength-3,strLength);
    }
    ...
    public static Character getMiddleCharacter(String inputValue){
        int charTobeRetrieved = inputValue.length()/2;
        char[] charArray = inputValue.toCharArray();
        char middleChar;

        if (inputValue.length()%2 == 0)
        {
             middleChar = charArray[charTobeRetrieved - 1];

        }
        else
        {
             middleChar = charArray[charTobeRetrieved];
    ...
    public static String getFirstWord(String spaceDelimitedString){
        String[] stringArray =   spaceDelimitedString.split("\\s");
